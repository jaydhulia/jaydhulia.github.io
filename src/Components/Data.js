export const workExperienceData = [
  {
    ...
    responsibilities: [
      ...
      "Established and led the vision and strategic direction for AWS developer workflows, enforcing secure guardrails while allowing for developer velocity",
      "Spearheaded the development of an internal IaC solution and other AWS management tools (such as ConsoleMe, Weep) to achieve the above vision",
